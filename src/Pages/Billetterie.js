    ...
    function BilletD() {   
        return ( 
          ...
          <div className="card-body">
            ...
            <a href="/LiveEvents/Billetterie" className="btn btn-danger bout">Complet</a>
          </div>
        </div>
      ...
      function BilletS() {   
        return ( 
          ...
          <div className="card-body">
            ...
            <p className="card-text">Valable le 10/07/2027 </p>
            <a href="/LiveEvents/Billetterie" className="btn btn-danger">Complet</a>
          </div>
        </div>
      ...
      function BilletV() {   
        return ( 
          ...
          <div className="card-body">
            ...
            <a href="/LiveEvents/Billetterie" className="btn btn-primary bout">Acheter</a>
          </div>
        </div>
      ...
      function Pass2joursSD() {   
        return ( 
          ...
          <div className="card-body">
            ...
            <a href="/LiveEvents/Billetterie" className="btn btn-primary">Acheter</a>
          </div>
        </div>
